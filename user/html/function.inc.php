...
function sentInvoice($con,$order_id){
	$res=mysqli_query($con,"select distinct(product_detail.id) ,product_detail.*
	,product.name,
	product.image from product_detail,product ,`order`
	 where product_detail.order_id='$order_id' and 
	product_detail.product_id=product.id");
	$user_order=mysqli_fetch_assoc(mysqli_query($con,"select `order`.*, 
	users.name,users.email
	  from `order`,users where users.id=`order`.user_id and `order`.id='$order_id'"));
	  $total_price=0; 
	...
	<html>
	  ...
	  <body>
		...
		'.$user_order['added_on'].'. Please submit payment by {{ due_date }}</span>
					  ...
					  <tr>
						<td class="content-cell">
						  <div class="f-fallback">
							...
							<p>Thanks for using
							 [Product Name]. This is an invoice for your recent purchase.</p>
		...
		$html.='<tr>
									  ...
									  <td width="20%" class="purchase_footer" valign="middle">
										<p class="f-fallback purchase_total">'.$pp.'</p>
									  </td>
									</tr>
								  </table>
								</td>
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="nikitasharma62054@gmail.com";
	$mail->Password="nikita@123";
	$mail->setFrom("nikitasharma62054@gmail.com");
