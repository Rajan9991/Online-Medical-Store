...
<main >
    <div class="wrapper">
        ...
        <div class="wrapper_content" style="background:#fff;">
        <?php
         $cart_total=0;
...
<a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','update')" id="<?php echo $key?>qty"  value="<?php echo $qty?>"
 style="background-color: #ff3f6c; color:#fff;  font-weight: 600;  padding: 10px 15px; cursor: pointer;">Update</a> </p>            
                    </div>
                <div class="price">
                ...
                <div class="product_btns">
                    <div class="remove" ><a href="javascript:void(0)" style="color:#707B7C;" onclick="manage_cart('<?php echo $key ?>','remove')">REMOVE</a></div>
<div class="whishlist" ><a href="<?php echo SITE_PATH?>" style="color:#707B7C;">Countinue Shopping</a></div>
                </div>
        ...
        <div class="wrapper_amount" >
            ...
            <div class="price_details" style="background:#fff;
   border-radius: 2rem;
   text-align: center;
   position: relative;
   overflow: hidden;
  ...
  ">
                ...
                <div class="item">
                    <p>Order Total :</p>
                    <p><span>&#8377</span>&nbsp;<?php echo $cart_total?></p>
                </div>
            ...
            <div class="checkout">
                <a href="<?php echo SITE_PATH?>checkout.php" role="button" class="checkout_btn"> PROCEED TO CHECKOUT</a>
            </div>
        </div>
    </div>
    </main>
